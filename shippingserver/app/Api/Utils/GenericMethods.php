...
use Api\Requests\FCLBuyerPostRequest;
...
class GenericMethods
{
    public static function convert_db_object_to_json($buyerPost)
    {
        ...
        $buyerPostRequest
            ...
            ->setAttributes($dbObj["attributes"]);
    ...
    public static function boolean_converter($bool)
    {
        if ($bool)
            return 1;
        else
