...
class LCLBuyerSellerPostRecommender
{
    ...
    private function _filterSellerInboundPostMaster($sellerId, LCLSellerPostMasterInboundSearchBO $filter)
    {
        ...
        $results = new LCLSellerPostMasterInboundSearchResultsBO();
    ...
    public function computeSellerLeadsEnquiries($sellerId)
    {
        ...
        $rowsAffected = DB::delete("delete from shp_seller_leads where service_id = ? and seller_id = ? ", [LCL, $sellerId]);

        Log::debug($rowsAffected . " deleted from seller leads cache for serviceId = " . LCL . ", sellerId = " . $sellerId);
        ...
        DB::insert($query1, [LCL, $sellerId, $sellerId, LCL, $sellerId]);
        ...
        DB::update($query2, [$sellerId, LCL, $sellerId, LCL]);
        ...
        DB::update($query3, [$sellerId, LCL, $sellerId, LCL]);
