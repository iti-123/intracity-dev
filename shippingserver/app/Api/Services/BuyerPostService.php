...
use Api\BusinessObjects\BuyerPostMasterInboundGroup;
use Api\BusinessObjects\BuyerPostMasterInboundResults;
use Api\BusinessObjects\BuyerPostSearchBO;
use Api\BusinessObjects\ContractBO;
use Api\BusinessObjects\PostMasterGroup;
use Api\Model\BuyerContract;
use Api\Model\BuyerPost;
use Api\Model\ContractItems;
use Api\Model\SelectedSellers;
use Api\Model\SellerQuotes;
use Api\Repositories;
use Api\Requests\Containers;
use Api\Requests\Routes;
use Api\Services\IBuyerPost;
    ...
    public function filterPostMasterInbound(BuyerPostSearchBO $bo)
    {
        ...
        try {
            ...
            $relatedSpotEnquiriesSql = "
                  ...
                  from shp_order_items oi, shp_seller_post_index spi
