    ...
    <body>
        <div style="position:absolute;left:50%;margin-left:-306px;top:0px;width:612px;height:792px;border-style:outset;overflow:hidden">
            <div style="position:absolute;left:0px;top:0px">
                <img src="/home/sainath/shipping/shippingserver/public/images/background1.jpg" width="612" height="792">
            </div>
            <div style="position:absolute;left:264.93px;top:119.58px" class="cls_002">
                <span class="cls_002">Invoice for FTL</span>
            </div>
            ...
            <div style="position:absolute;left:217.25px;top:454.71px" class="cls_003">
                <span class="cls_003">From Guntur To Vijayawada</span>
            </div>
