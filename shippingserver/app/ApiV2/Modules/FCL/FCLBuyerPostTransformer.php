...
use ApiV2\Modules\FCL\BuyerPost\Container;
use ApiV2\Modules\FCL\BuyerPost\DestinationCustoms;
use ApiV2\Modules\FCL\BuyerPost\ExportTPT;
use ApiV2\Modules\FCL\BuyerPost\GOH;
use ApiV2\Modules\FCL\BuyerPost\HazardousAttributes;
use ApiV2\Modules\FCL\BuyerPost\ODC;
use ApiV2\Modules\FCL\BuyerPost\OriginCustoms;
use ApiV2\Modules\FCL\BuyerPost\SpecialCondition;
use ApiV2\Modules\FCL\BuyerPost\TankTainer;
use ApiV2\Modules\FCL\BuyerPost\TemperatureAttributes;
...
class FCLBuyerPostTransformer implements IBuyerPostTransformer
{
    ...
    private function spot_xls2base(array $master = [], array $sellers = [])
    {
        ...
        $bo->serviceId = 22; //TODO donot hard code service-id
