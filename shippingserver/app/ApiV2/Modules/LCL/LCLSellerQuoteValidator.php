...
use ApiV2\Framework\AbstractSellerQuoteValidator;
use ApiV2\Framework\ISellerQuoteValidator;
use ApiV2\Services\LocationService;
use ApiV2\Utils\DateUtils;
use Log;

class LCLSellerQuoteValidator extends AbstractSellerQuoteValidator implements ISellerQuoteValidator
{
