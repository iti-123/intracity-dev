...
use ApiV2\Framework\ISellerPostTransformer;
use ApiV2\Framework\SerializerServiceFactory;
use League\Fractal\TransformerAbstract;
use Log;

//use ApiV2\Transformers\SellerPostBOTransformer;

class LCLSellerPostTransformer extends TransformerAbstract implements ISellerPostTransformer
{
    ...
    public function ui2bo_save($payload)
    {
        ...
        $post = $serializer->deserialize($payload, 'Api\Modules\LCL\LCLSellerPostBO', 'json');
        return $post;
    ...
    public function ui2bo_filter($payload)
    {
        //Convert the request JSON into a BO
        $serializer = SerializerServiceFactory::create();
        $post = $serializer->deserialize($payload, 'Api\Modules\LCL\LCLSellerPostSearchBO', 'json');
        return $post;
    }
...
//TODO: Implement model2boGet() method.
    ...
    {
        $response = 'LCLSellerPostTransformer.model2boSave() called';
        LOG::info($response);
    ...
    {
        $response = 'LCLSellerPostTransformer.bo2modelDelete() called';
        LOG::info($response);
        return ((array)$response);
    }
    ...
    {
        $response = 'LCLSellerPostTransformer.bo2modelSave() called';
        LOG::info($response);
        return ((array)$response);
    }
    ...
    public function bo2modelGet($bo)
    {
        ...
        $response = 'LCLSellerPostTransformer.bo2modelGet() called';
        LOG::info($response);
        return ((array)$response);
    }
    ...
    {
        // TODO: Implement ui2bo_postmaster_filter() method.
    }

    public function ui2bo_postmasterinbound_filter($payload)
    {
        // TODO: Implement ui2bo_postmasterinbound_filter() method.
    }
