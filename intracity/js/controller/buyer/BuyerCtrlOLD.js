        ...
        if (validate(data)) {
            if (typeof (data.length) != 'undefined' || data.length != '') {
                if ($scope.update_id === '' || $scope.update_id == undefined) {
                    ...
                    // console.log("cOPIED Data Ins::", angular.copy(data));
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.isSuccessful) {
                            ...
                            var str = "Your request for post has been successfully posted to the relevant buyers. Your transacton id is " + tran + " You would be getting the enquiries from the buyers online."
            ...
            if (validateQuote(data)) {
                ...
                $http({
                    ...
                    if (response.data.isSuccessful) {
                        var tran = response.data.payload.data.post_transaction_id;
                        var str = "Your request for post has been successfully posted to the relevant buyers. Your transacton id is" + tran + " You would be getting the enquiries from the buyers online."
