app.controller('HpSellerCtrl', ['$scope', '$http', 'config', 'apiHyperlocalServices', 'type_basis', 'discount', '$state', '$location', 'apiServices','$dataExchanger','trackings','$window',function ($scope, $http, config, apiHyperlocalServices, type_basis, discount, $state, $location, apiServices,$dataExchanger,trackings,$window) {
